...
function SortableColumnRow({ column, index, onUpdate, onRemove, canRemove, t }: SortableColumnRowProps) {
  const {
    attributes,
    listeners,
    setNodeRef,
        ...
        <div className="editor-actions">
          ...
          >
            {saveStatus === 'saving' ? t('common.saving') : 
             ...
             saveStatus === 'error' ? t('errors.failedToSave') : 
             t('common.save')}
          </button>
        </div>
      </div>
      ...
      <div className="editor-grid">
        ...
        <section className="editor-section card">
          <div className="section-header">
            <h2>{t('template.tiers')} ({tiers.length})</h2>
        ...
        <section className="editor-section card">
          <div className="section-header">
            <h2>{t('template.columns')} ({columns.length})</h2>
        ...
        <section className="editor-section card cards-section">
          <div className="section-header">
            <h2>{t('template.cards')} ({cards.length})</h2>
